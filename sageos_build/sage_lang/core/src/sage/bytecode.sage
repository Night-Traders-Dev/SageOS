...
let BC_OP_NEGATE = 20
let BC_OP_EQUAL = 21
let BC_OP_NOT_EQUAL = 22
let BC_OP_GREATER = 23
let BC_OP_GREATER_EQUAL = 24
let BC_OP_LESS = 25
let BC_OP_LESS_EQUAL = 26
let BC_OP_BIT_AND = 27
let BC_OP_BIT_OR = 28
let BC_OP_BIT_XOR = 29
let BC_OP_BIT_NOT = 30
let BC_OP_SHIFT_LEFT = 31
let BC_OP_SHIFT_RIGHT = 32
let BC_OP_NOT = 33
let BC_OP_TRUTHY = 34
let BC_OP_JUMP = 35
let BC_OP_JUMP_IF_FALSE = 36
let BC_OP_CALL = 37
let BC_OP_CALL_METHOD = 38
let BC_OP_ARRAY = 39
let BC_OP_TUPLE = 40
let BC_OP_DICT = 41
let BC_OP_PRINT = 42
let BC_OP_EXEC_AST_STMT = 43
let BC_OP_RETURN = 44
let BC_OP_PUSH_ENV = 45
let BC_OP_POP_ENV = 46
let BC_OP_DUP = 47
let BC_OP_ARRAY_LEN = 48
