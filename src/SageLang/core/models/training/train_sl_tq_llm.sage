...
# --- Documentation ---
let corpus_docs = ""
let doc_files = ["docs/SageLang_Guide.md", "docs/GC_Guide.md", "docs/LLM_Guide.md", "docs/Agent_Chat_Guide.md", "docs/StdLib_Guide.md"]
let doc_count = 0
