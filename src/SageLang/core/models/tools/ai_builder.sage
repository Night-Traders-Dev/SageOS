...
proc step_rag():
    ...
    if prompt_yn("Index Sage documentation?"):
        let doc_files = ["docs/SageLang_Guide.md", "docs/LLM_Guide.md", "docs/StdLib_Guide.md", "docs/Agent_Chat_Guide.md"]
...
print_header("SageLLM AI Builder v3.7.9")
